...
import {
  useDepositPendingMultiQuery,
  Deposit,
  Pagination,
} from "@/hooks/queries/backoffice/deposit/pending/multi";
...
const DepositMultiTable = (props: Props) => {
  const { type } = props;
  ...
  const { data, isLoading, isError } = useDepositPendingMultiQuery({
    menutype: type,
    ...pagination,
  });
...
export default DepositMultiTable;
