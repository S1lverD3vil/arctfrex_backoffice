      ...
      items: [
        {
          ...
          items: [
            {
              title: "SPA",
              href: "/management-account/real-account/spa",
              color: "orange",
            },
            {
              title: "Multi",
              href: "/management-account/real-account/multi",
              color: "blue",
            },
          ],
        },
        {
          ...
          items: [
            {
              title: "SPA",
              href: "/management-account/demo-account/spa",
              color: "orange",
            },
            {
              title: "Multi",
              href: "/management-account/demo-account/multi",
              color: "blue",
            },
          ],
        },
...
export default ManagementAccountMenu;
