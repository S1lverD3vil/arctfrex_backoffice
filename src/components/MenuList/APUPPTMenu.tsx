  ...
  const [items, setItems] = useState([
    {
      ...
      items: [
        {
          title: "Database DTTOT",
          toggle: false,
          items: [
            {
              title: "Input Manual",
              href: "/apuppt/database-dttot/input-manual",
              color: "orange",
            },
            {
              title: "Upload File",
              href: "/apuppt/database-dttot/upload-file",
              color: "blue",
            },
          ],
        },
        {
          title: "Database DPPSPM",
          items: [
            {
              title: "Input Manual",
              href: "/apuppt/database-dttot/input-manual",
        ...
        {
          title: "Database Penilaian Resiko",
          href: "/apuppt/database-penilaian-resiko",
        },
      ],
    },
  ]);
